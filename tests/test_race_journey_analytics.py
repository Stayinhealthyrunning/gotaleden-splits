...
class RaceJourneyAnalyticsTests(unittest.TestCase):
    ...
    def test_journey_assets_are_ordered_and_lifecycle_is_scoped_to_detail(self):
        self.assertIn("runner-replay.js?v=20260921-acceptance1", self.html)
        self.assertIn("profile-journey.js?v=20260904-journey2", self.html)
        self.assertIn("data-adapter.js?v=20260911-e4", self.html)
        self.assertIn("app.js?v=20260925-sprint1", self.html)
        self.assertIn("charts.js?v=20260921-finish-progression1", self.html)
        self.assertIn("style.css?v=20260925-sprint1", self.html)
