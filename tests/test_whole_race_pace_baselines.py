...
"""
    ...
    def test_reference_lines_copy_and_cache_versions(self):
        ...
        self.assertIn("data-adapter.js?v=20260904-course-difficulty1", self.html)
        self.assertIn("interactive-analysis.js?v=20260904-course-difficulty1", self.html)
        self.assertIn("app.js?v=20260904-course-difficulty1", self.html)
