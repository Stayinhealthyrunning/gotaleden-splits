...
CREATE TABLE IF NOT EXISTS races (
  ...
  race_type TEXT NOT NULL CHECK(length(race_type) > 0),
  participant_entity TEXT NOT NULL CHECK(participant_entity IN ('person','team')),
  competition_format TEXT NOT NULL,
  team_structure_json TEXT NOT NULL,
